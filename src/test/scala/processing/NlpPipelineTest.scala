...
class NlpPipelineTest extends FlatSpec with Matchers {
  ...
  "NlpPipeline" should "transform a text to a normalized bag of words" in {
    ...
    text shouldBe Set(
      "esther", "mois", "assidue", "temps", "ignorer", "compagne", "chercher", "mémoire", "gloire", "soupirer", "jour", "descendre", "désert", "élise", "bénir", "aider", "joug", "heureux", "oppression", "cacher", "malheur", "premiers", "souffrir", "chere", "an", "climat", "benjamin", "sion", "voeux")
  }
  ...
  "NlpPipeline" should "transform a text - " in {
    ...
    val text = pipeline.normalize(
      ...
      """.stripMargin)
    text shouldBe Set(
      "droit", "prédestiner", "combattre", "chaleur", "déjà", "artifice", "aurore", "soupir", "enflamme", "point", "discorde", "combat", "arme", "humilier", "voir", "splendeur", "déployer", "chéris", "chercher", "perfide", "animé", "sacrés", "confondre", "nation", "briser", "mémoire", "affreuse", "front", "yeux", "forts", "écoute", "roi", "perte", "feu", "gloire", "tendre", "animer", "écrit", "piété", "hérésie", "funèbre", "unir", "frémir", "etendards", "enfer", "jalousie", "vivre", "dévorer", "couronner", "braver", "couvrir", "ouvrage", "debris", "livre", "jour", "fureur", "pavé", "ferme", "jeter", "zèle", "ténèbre", "grand", "armée", "fille", "venir", "temple", "demon", "frontière", "juger", "offrir", "répandre", "querelle", "allumer", "nom", "fonder", "Rhin", "barrière", "desirs", "regarder", "foi", "écouter", "soin", "soutenir", "auguste", "couchant", "cause", "abandonner", "saints", "voix", "rompre", "orgueil", "amour", "écueil", "Main", "prendre", "baiser", "place", "vapeur", "dieu", "aveugle", "respect", "partout", "impuissant", "exemple", "religion", "invariable", "Centre", "édifice", "reconnaitre", "ennemis", "intérêt", "étrangère", "prosterné", "graver", "disperser", "bras")
  }
